...
<p>
  <a href="https://github.com/sure-trust/VED-DEVANAND-DHANOKAR-g37-ai-ml/tree/main/Final%20capstone%20project/accident_detection" target="_blank"><strong>→ View Full Project Report</strong></a>
</p>

<!-- Project 2 -->
<h3 id="project2">Project 2: breast-cancer-using-resnet18</h3>
<p>
  breast cancer detection using the ResNet18 deep learning model for medical image classification. It uses transfer learning and convolutional neural networks (CNNs) to analyze breast cancer images and classify them as cancerous or non-cancerous with high accuracy. The project demonstrates the practical use of AI in healthcare for early disease detection and medical diagnosis support
</p>
<p>
  <a href="https://github.com/Ved2151H/breast-cancer-using-resnet18" target="_blank"><strong>→ View Full Project Report</strong></a>
</p>

<!-- Project 3 -->
<h3 id="project3">Project 3: DocuMind AI</h3>
<p>
 DocuMind AI is an intelligent document assistant that uses Ollama-powered local large language models to analyze and interact with uploaded documents. The project applies Retrieval-Augmented Generation (RAG) techniques to extract insights, answer questions, summarize content, and improve document understanding while keeping data processing local and privacy-focused. It demonstrates practical implementation of AI, NLP, vector search, and local LLM integration for real-world document analysis applications.
</p>
<p>
...
<img src="Community%20Services/20260405_132546.jpg" width="30%">
